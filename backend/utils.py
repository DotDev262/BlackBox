...
def calculate_price(distance_km, weight_kg, item_type):
    BASE_FEE = 49
    MIN_PRICE = 199
    MAX_PRICE = 1499

    # Distance slabs
    if distance_km <= 50: distance_fee = 30
    elif distance_km <= 150: distance_fee = 60
    elif distance_km <= 300: distance_fee = 100
    elif distance_km <= 600: distance_fee = 150
    else: distance_fee = 200
